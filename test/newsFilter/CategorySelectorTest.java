...
public class CategorySelectorTest {
	...
	public void setUp(){
		...
		wantedCategories.add("Status Reports");
	...
	public void should_select_only_news_with_correct_categories() {
		...
		News news1 = new News("headline 1", "some text 1", now.toString(), null, wantedCategories);
		News news2 = new News("headline 2", "some text 2", now.toString(), null, wantedCategories);
		News news3 = new News("headline 3", "some text 3", now.toString(), null, new ArrayList<String>());
		News news4 = new News("headline 4", "some text 4", now.toString(), null, notWantedCategories);
